...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-4awllw.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-4awllw.containers.anotherwebservice.com/
...
```
git clone git@github.com:Enzzo32nfred/container-4awllw.git
cd container-4awllw
```
...
```
docker attach container-4awllw
```
